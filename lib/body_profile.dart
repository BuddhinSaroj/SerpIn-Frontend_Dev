...
class _BodyState extends State<Body> {
  ...
  void initState() {
    if (photo == null || name == null) {
      photo =
          "https://images.unsplash.com/photo-1473081556163-2a17de81fc97?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=387&q=80";
      name = " ";
    }
        ...
        child: Column(
          children: [
            ...
            Text(
              name!,
              style: TextStyle(
                  color: createMaterialColor(Color(0xFF36454F)),
                  fontSize: 25,
                  fontFamily: 'Klasik'),
            ),
            SizedBox(height: 16),
            ...
            ProfileMenu(
              ...
              press: () => showCustomSnackBar(
                  context, 'Option is not available right now'),
            ),
            ProfileMenu(
              text: "Help Center",
